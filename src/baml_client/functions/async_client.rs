...
baml_function_async!(ResolveConflict(files: &[types::ConflictInput], ) -> (stream_types::ConflictResolution, types::ConflictResolution));
...
pub struct BamlAsyncClient {
    ...
    pub ResolveConflict: ResolveConflict,
}
...
impl BamlAsyncClient {
    pub const fn new() -> Self {
        Self {
            ...
            ResolveConflict: ResolveConflict::new(),
        }
    }
