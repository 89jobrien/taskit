...
impl TypeBuilder {
    ...
    /// Access the `ConflictInput` class builder.
    pub fn ConflictInput(&self) -> ConflictInputClassBuilder {
        ConflictInputClassBuilder::new(
            self.inner
                .get_class("ConflictInput")
                .expect("class ConflictInput is defined in schema"),
        )
    }

    /// Access the `ConflictResolution` class builder.
    pub fn ConflictResolution(&self) -> ConflictResolutionClassBuilder {
        ConflictResolutionClassBuilder::new(
            self.inner
                .get_class("ConflictResolution")
                .expect("class ConflictResolution is defined in schema"),
        )
    }

    /// Access the `ResolvedConflict` class builder.
    pub fn ResolvedConflict(&self) -> ResolvedConflictClassBuilder {
        ResolvedConflictClassBuilder::new(
            self.inner
                .get_class("ResolvedConflict")
                .expect("class ResolvedConflict is defined in schema"),
        )
    }
